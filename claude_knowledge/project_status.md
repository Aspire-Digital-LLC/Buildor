...
- [x] **All tool calls through operation pool**: `ef49482` forces every tool call permission response through the pool pipeline, not just explicit user approvals. Auto-accepts and "Always Allow" rules also route through `respondToPermissionPooled`.
